...
class tokenHandle final {
 ...
 private:
  static std::pair<Token, std::string_view> GetNoNumTokenFromStr(const std::string_view& str);
  static std::pair<Token, std::string_view> GetNumTokenFromStr(const std::string_view& str);
